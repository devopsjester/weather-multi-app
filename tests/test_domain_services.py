...
class TestLocationValidatorService:
    ...
    def test_validate_city_state_country_valid(self):
        ...
        assert LocationValidatorService.validate_city_state_country("Toronto", "ON", "Canada") is True
        assert LocationValidatorService.validate_city_state_country("London", "England", "UK") is True
    ...
    def test_validate_city_state_country_invalid(self):
        ...
        assert LocationValidatorService.validate_city_state_country("Toronto", "", "Canada") is False
...
class TestWeatherUnitsService:
    ...
    def test_get_temperature_unit_for_us_location(self):
        ...
        assert WeatherUnitsService.get_temperature_unit_for_location(us_location) == TemperatureUnit.FAHRENHEIT
        assert WeatherUnitsService.get_temperature_unit_for_location(zipcode_location) == TemperatureUnit.FAHRENHEIT
    ...
    def test_get_temperature_unit_for_international_location(self):
        ...
        assert WeatherUnitsService.get_temperature_unit_for_location(international_location) == TemperatureUnit.CELSIUS
